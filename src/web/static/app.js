...
const i18n = {
  es: {
    ...
    aaPrefix: 'Retransmitir pendientes desde bloque', aaGap: 'con', aaSuffix: 'bloques entre cada tx',
    assign: 'Asignar', importTx: 'Importar TX',
    ...
    confirmed_title: 'Retransmitidas \u00faltimos 3 bloques',
  ...
  en: {
    ...
    confirmed_title: 'Broadcast last 3 blocks',
